...
# Version: 0.2
# Geoff Lewis <gsl@gslsrc.net> -- public domain 2011
#
# A very basic and quite specific (to my needs) task manager using bash and
# sqlite3.  In the (unlikely) event its work flow is applicable to you,
# enjoy!
#
# See the README.md for some usage details.
...
DATABASE=$HOME/.$(basename $0 .sh).db
